...
def random_person():
    ...
    uuid = random_function.random_uuid()
    name = profile['name']
    password = random_function.random_password()
    job = profile['job']
    ...
    if gender == 'M':
        gender_for_imgpath = "Man"
    else:
        gender_for_imgpath = "Woman"
    img_path = random_function.get_img_path(age, gender_for_imgpath)
